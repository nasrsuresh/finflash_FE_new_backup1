const DataCard = ({ data, index, onSelect, isSelected }) => {
  ...
  return (
    <div
      ...
      className={`flex gap-2  itmes-start border p-5 flex-row m-2 rounded-md cursor-pointer hover:shadow-lg ${isSelected ? "border-[#C00000] bg-[#F9E6E6]" : "bg-gray-300 md:bg-[unset]"}`}
    >
      <div
