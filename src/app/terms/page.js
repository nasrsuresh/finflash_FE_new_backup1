    ...
    <main ref={mainref} className={`${inter.className} h-[100vh]"`}>
      <Header modalContainer={mainref} />
       <div className="container mx-auto p-4" style={{ fontFamily: 'Arial, sans-serif' }}>
          <h1 style={{ borderBottom: '2px solid #333', paddingBottom: '10px' }}>Terms and Conditions</h1>
          ...
          <h2 style={{ marginTop: '20px' }}>You must not:</h2>
          ...
          <h2 style={{ marginTop: '20px' }}>This Agreement shall begin on the date hereof.</h2>
